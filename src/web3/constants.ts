...
const VAULT_ABI = [
  ...
  },
  {
    ...
    inputs: [
      { name: '_newOperator', type: 'address', internalType: 'address' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    ...
    inputs: [
      { name: '_player', type: 'address', internalType: 'address' },
      { name: '_newBalance', type: 'uint256', internalType: 'uint256' },
      { name: '_reason', type: 'string', internalType: 'string' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
...
export { RPC_URL, TOKEN_ABI, TOKEN_ADDRESS, VAULT_ABI, VAULT_ADDRESS };
